...
class ApplicationDelegation(Base):
    ...
    DB_DATE_DECKED_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_EVAL_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_CHECKER_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_SUPERVISOR_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_QA_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_DIRECTOR_END = Column(DateTime(timezone=True), nullable=True)
    ...
    DB_DATE_RELEASING_OFFICER_END = Column(DateTime(timezone=True), nullable=True)  # ✅ Fixed name
