...
from app.schemas.cpr_correction import (
    DTNVerifyResponse,
...
def verify_dtn(dtn: str, db: Session) -> DTNVerifyResponse:
    ...
    record: MainDB | None = db.query(MainDB).filter(MainDB.DB_DTN == dtn_int).first()
...
def submit_correction(
    payload: CorrectionSubmitRequest, db: Session, current_user: User
) -> CorrectionSubmitResponse:
    """
    ...
    new_record = MainDB(
        ...
        DB_PROD_CLASS_PRESCRIP=payload.prod_class_prescript
        or original.DB_PROD_CLASS_PRESCRIP,
        DB_PROD_ESS_DRUG_LIST=payload.prod_ess_drug_list
        or original.DB_PROD_ESS_DRUG_LIST,
        DB_PROD_DISTRI_SHELF_LIFE=payload.prod_distri_shelf_life
        or original.DB_PROD_DISTRI_SHELF_LIFE,
        ...
        DB_PROD_TRADER_COUNTRY=payload.prod_trader_country
        or original.DB_PROD_TRADER_COUNTRY,
        DB_PROD_TRADER_LTO_NO=payload.prod_trader_lto_no
        or original.DB_PROD_TRADER_LTO_NO,
        ...
        DB_PROD_IMPORTER_COUNTRY=payload.prod_importer_country
        or original.DB_PROD_IMPORTER_COUNTRY,
        DB_PROD_IMPORTER_LTO_NO=payload.prod_importer_lto_no
        or original.DB_PROD_IMPORTER_LTO_NO,
        ...
        DB_PROD_DISTRI_COUNTRY=payload.prod_distri_country
        or original.DB_PROD_DISTRI_COUNTRY,
        DB_PROD_DISTRI_LTO_NO=payload.prod_distri_lto_no
        or original.DB_PROD_DISTRI_LTO_NO,
        ...
        DB_PROD_REPACKER_COUNTRY=payload.prod_repacker_country
        or original.DB_PROD_REPACKER_COUNTRY,
        DB_PROD_REPACKER_LTO_NO=payload.prod_repacker_lto_no
        or original.DB_PROD_REPACKER_LTO_NO,
        ...
        DB_CPR_COND_ADD_REMARKS=payload.cpr_cond_add_remarks
        or original.DB_CPR_COND_ADD_REMARKS,
