...
Revision ID: 8826e5aed3e7
Revises: 3b4cdf6bfd65
Create Date: 2025-12-26 17:00:58.655900
...
revision: str = '8826e5aed3e7'
down_revision: Union[str, Sequence[str], None] = '3b4cdf6bfd65'
...
def upgrade() -> None:
    ...
    sa.Column('DB_DATE_ISSUED', sa.Date(), nullable=True, comment='Date Issued'),
